...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .noticia-card { background: white; border-radius: 10px; box-shadow: 0 3px 15px rgba(0,0,0,0.1); margin-bottom: 30px; overflow: hidden; }
            ...
            <?php while ($noticia = $result->fetch_assoc()): ?>
                <div class="noticia-card">
                    ...
                    <div class="noticia-conteudo">
                        ...
                        <div class="noticia-texto"><?php echo htmlspecialchars($noticia['noticia']); ?></div>
                    </div>
                </div>
            <?php endwhile; ?>
        <?php else: ?>
